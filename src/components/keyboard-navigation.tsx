...
export namespace KeyboardNavigation {
    ...
    export const keyboardToMouseClickEvent = <T extends HTMLElement>(
    ...
    export const isClick = (event: KeyboardEvent<HTMLDivElement>) =>
