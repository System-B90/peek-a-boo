...
export function RefreshGlyph({
    ...
    return (
        <Glypher glyphTitle={glyphTitle} placement={placement} {...props}>
            <div className="svg-glyph refresh-glyph">
                <svg
                    fill="currentColor"
                    viewBox="0 0 32 32"
