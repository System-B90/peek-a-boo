...
const DEFAULT_SETTINGS = {
    ...
    HIVE_POSTGRES_USERNAME: process.env.HIVE_POSTGRES_USERNAME ?? "grafanareader",
...
// Cache for runtime
let cachedSettings: UserControlledSettings | null = null;
 ...
 */
export async function getSetting(key: keyof UserControlledSettings): Promise<string>
{
    if (!cachedSettings)
    {
...
export async function getSettings(): Promise<UserControlledSettings>
{
    if (!cachedSettings)
    {
        ...
        for (const key of Object.keys(loadedSettings) as Array<keyof UserControlledSettings>)
        {
